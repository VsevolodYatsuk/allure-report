...
def test_user_registration(opencart_page):
    ...
    step_input_text(opencart_page, By.XPATH, "//input[@id='register_email']", "sevateti2@yandex.com")
    step_input_text(opencart_page, By.XPATH, "//input[@id='register_password']", "ctdf20051906")
    step_input_text(opencart_page, By.XPATH, "//input[@id='register_confirm_password']", "ctdf20051906")
    step_input_text(opencart_page, By.XPATH, "//input[@id='register_firstname']", "Vsevolod")
    step_input_text(opencart_page, By.XPATH, "//input[@id='register_lastname']", "Yatsuk")
